#  Отчёт по проекту: дообучение модели WAN 2.2 TI2V 5.5

## Цель проекта
Создать и дообучить модель **WAN 2.2 TI2V 5.5** для генерации видео из изображений (*Image-to-Video*).  
...
## Что уже сделано
- Настроен **API-сервис** для генерации видео (`FastAPI` + `Docker`)
